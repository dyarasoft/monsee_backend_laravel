...
class TransactionController extends Controller
{
    ...
    /**
     * Get transactions for a specific wallet with optional date filtering.
     *
    ...
    {
        // Authorize: Make sure the user owns the wallet
        ...
        $categorySpendingQuery = $wallet->transactions()
                                    ...
                                    ->select('categories.name as category_name', 'categories.color', 'categories.icon', DB::raw('SUM(transactions.amount) as total_amount'))
